...
const Commitments = () => {
  return (
    <div>
      <div
        role="button"
        className="bg-green-600 flex justify-between text-white font-semibold py-2 px-5"
      >
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8 py-3 bg-orange-200 px-5">
